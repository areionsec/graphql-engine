...
### 4. Polymorphic configuration

Use with polymorphic tables.
Same configuration as "Manual Configuration", adding a field named
`polymorphic_column` which is the column that holds the constant
  ...
  "args": {
      ...
      "using": {
          "polymorphic_configuration" : {
              ...
              "polymorphic_column": "resource_model_type"
          }
      }
  }
}
